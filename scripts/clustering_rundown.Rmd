---
title: "ROSMAP snRNA-seq Clustering"
author: "Won-Min Song"
...
## PCA data
Now, let's perform PCA. We will use scran's getDenoisedPCs routine to find denoised data, based on the biological signals from modelGeneVar(). 
...
```{r cell type markers, echo=FALSE}
...
```{r composition analysis, echo=FALSE}
